...
function updateVariablePayLabel() {
    ...
    document.getElementById('variablePayLabel').innerText = variablePay + '%';
}
...
function calculateBreakup() {
    ...
    for (c = 0; c < components.length; c++) {
        ...
        componentsStr += '<br>' + components[c][4] + ' = ' + Math.round(Number(amt), 2);
    }
    componentsStr += '<br><b>Total Components</b>: ' + Math.round(componentAmt);
